...
public class CatacombsOverflowOverlay {
    ...
    private static void draw(GuiGraphicsExtractor ctx, ItemStack stack, int x, int y) {
        ...
        String name = COLOR_STRIP.matcher(stack.getHoverName().getString()).replaceAll("")
    ...
    private static void dumpDebug(ItemStack stack, String name) {
        ...
        fishmod.utils.Misc.addChatMessage(net.minecraft.network.chat.Component.literal(sb.toString()));
    }
}
