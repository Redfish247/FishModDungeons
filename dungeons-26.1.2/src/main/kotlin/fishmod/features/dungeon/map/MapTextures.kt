...
object MapTextures {
    ...
    // No dedicated "question mark" asset exists in the ported System22 resources (verified: not present
    // under assets/system22/map/ either). Reuse WHITE_CHECK as the unopened-room placeholder icon.
