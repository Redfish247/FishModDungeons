...
class FishModScreen : Screen(Component.literal("FishMod")), HasNvgOverlay {
    ...
    private fun buildCategories() {
        ...
        run {
            ...
            f.sub.add(ToggleSetting("Necron LB Timer", "Counts down from the start of Necron's phase to the LB shot, then says SHOOT LB", Floor7::enableNecronLbTimer))
            f.sub.add(SliderDoubleSetting("Shoot At (s)", "Seconds into Necron's phase", Floor7::necronLbTargetSeconds, 1.0, 20.0).gatedBy { Floor7.enableNecronLbTimer })
