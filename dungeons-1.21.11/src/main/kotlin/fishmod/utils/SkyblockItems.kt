...
/** Resolves display names to Skyblock item IDs from the Hypixel items resource; falls back silently to empty on fetch failure. */
object SkyblockItems {
    ...
    /** Case-insensitive autocomplete search: prefix matches rank before substring matches, capped at `limit`. */
    @JvmStatic
