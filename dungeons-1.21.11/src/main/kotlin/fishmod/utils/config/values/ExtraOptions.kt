...
object ExtraOptions {
    ...
    @ConfigValue @JvmField var ragSound: SoundData = SoundData(SoundEvents.BLOCK_NOTE_BLOCK_PLING.value(), 1f, 1f)

    @ConfigValue @JvmField var sendOnPetSound: Boolean = false

    @ConfigValue @JvmField var petSound: SoundData = SoundData(SoundEvents.BLOCK_NOTE_BLOCK_PLING.value(), 1f, 1f)
    ...
    @ConfigValue @JvmField var ssSound: SoundData = SoundData(SoundEvents.BLOCK_NOTE_BLOCK_PLING.value(), 0f, 1f)
