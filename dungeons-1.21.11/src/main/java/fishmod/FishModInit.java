        ...
        com.mojang.brigadier.builder.LiteralArgumentBuilder<FabricClientCommandSource> tree =
                ClientCommandManager.literal("dwp")
                    ...
                    .then(ClientCommandManager.literal("size")
                        .then(ClientCommandManager.argument("value", com.mojang.brigadier.arguments.DoubleArgumentType.doubleArg(0.1, 1.0))
                            .executes(ctx -> {
                    ...
                    .then(ClientCommandManager.literal("distance")
                        .then(ClientCommandManager.argument("value", com.mojang.brigadier.arguments.IntegerArgumentType.integer(1))
                            .executes(ctx -> {
                    ...
                    .then(ClientCommandManager.literal("resetsecrets").executes(ctx -> {
                    ...
                    .then(ClientCommandManager.literal("useblocksize").executes(ctx -> {
                    ...
                    .then(ClientCommandManager.literal("import").executes(ctx -> {
